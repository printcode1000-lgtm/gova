...
Back up the dedicated database according to the same recovery policy used for other Gova Turso databases. Audit history and financial records must be included in retention and recovery checks.

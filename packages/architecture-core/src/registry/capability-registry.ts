...
export const CAPABILITY_PACKAGES: readonly CapabilityPackage[] = [
  ...
  {
    folder: 'control-composition',
    name: '@asol/control-composition',
    owns: 'Composition root for the control account',
    layer: 'composition',
    vendorModules: [],
    mayImportApp: true,
  },
  ...
  },
  {
    folder: 'dev-core',
    name: '@asol/dev-core',
    owns: 'Development-runtime guards for developer-only tooling',
    layer: 'capability',
    vendorModules: [],
    mayImportApp: false,
  },
  ...
  {
    folder: 'favorites-core',
    name: '@asol/favorites-core',
    owns: 'Device-local favorites state, card adapters, and the favorite control',
    layer: 'capability',
    vendorModules: [],
    mayImportApp: false,
  },
  ...
  {
    folder: 'gova-deployment-core',
    name: '@asol/gova-deployment-core',
    owns: 'The gova deployment build view and its artifact gate',
    layer: 'capability',
    vendorModules: [],
    mayImportApp: false,
  },
  ...
  {
    folder: 'product-card-core',
    name: '@asol/product-card-core',
    owns: 'Product card view model and reusable product card presentation',
    layer: 'capability',
    vendorModules: [],
    mayImportApp: false,
  },
  ...
  {
    folder: 'seller-card-core',
    name: '@asol/seller-card-core',
    owns: 'Seller card view model and reusable seller card presentation',
    layer: 'capability',
    vendorModules: [],
    mayImportApp: false,
  },
  ...
  },
  {
    ...
    owns: 'Vercel account API and deployment orchestration',
    layer: 'capability',

...
import { PROFILE_SOURCE_SQLITE_DB_PATH, SQLITE_DIRECTORY } from '../core/database/environment';

const MIGRATIONS_FOLDER = path.join(process.cwd(), 'packages', 'data-core', 'src', 'core', 'database', 'profile', 'migrations');

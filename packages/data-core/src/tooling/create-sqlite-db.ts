...
import { PRIMARY_SQLITE_DB_PATH, SQLITE_DIRECTORY } from '../core/database/environment';

const DB_DIR = SQLITE_DIRECTORY;
const DB_PATH = PRIMARY_SQLITE_DB_PATH;
const MIGRATIONS_FOLDER = path.join(process.cwd(), 'packages', 'data-core', 'src', 'core', 'database', 'migrations');

...
const VERIFY_ALL_SUBSTEPS = [
  ...
  ["test-seller-card-core", "بوابة seller-card-core", "npm run test:seller-card-core"],
  ["test-product-card-core", "بوابة product-card-core", "npm run test:product-card-core"],
  ["test-favorites-core", "بوابة favorites-core", "npm run test:favorites-core"],

...
def main():
    ...
    a=sp.add_parser('task-create'); a.add_argument('agent_id'); a.add_argument('goal'); a.add_argument('--task-id'); a.add_argument('--mode',required=True,choices=('A','B'))
    ...
    if x.cmd=='task-create': return call('POST','/v1/task/create',{'agent_id':x.agent_id,'goal':x.goal,'task_id':x.task_id,'execution_mode':x.mode})

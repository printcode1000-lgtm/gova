...
def main():
    ...
    a=sp.add_parser('task-create'); a.add_argument('agent_id'); a.add_argument('goal'); a.add_argument('--task-id')
    ...
    if x.cmd=='task-create': return call('POST','/v1/task/create',{'agent_id':x.agent_id,'goal':x.goal,'task_id':x.task_id})

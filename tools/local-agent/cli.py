...
def main():
    ...
    a=sp.add_parser('project'); a.add_argument('agent_id'); a.add_argument('task_id'); a.add_argument('integration_sha',help='Full SHA of the commit already published on origin/integration')
    ...
    if x.cmd=='project': return call('POST','/v1/canonical/project',{'agent_id':x.agent_id,'task_id':x.task_id,'integration_sha':x.integration_sha})

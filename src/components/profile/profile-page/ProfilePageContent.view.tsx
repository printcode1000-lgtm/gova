...
export function ProfilePageContentView({ model }: { model: ProfilePageContentModel }){
...
return showPreviewCard ? <ProfilePreviewView model={model} /> : <ProfileEditorView model={model} />;
}

import type { GovaMapLocation, GpsProvider } from './types';
...
const toLocation = (position: NativePosition, source: GovaMapLocation['source']): GovaMapLocation => ({ latitude: position.coords.latitude, longitude: position.coords.longitude, accuracy: position.coords.accuracy, heading: position.coords.heading ?? null, speed: position.coords.speed ?? null, timestamp: position.timestamp, source });

  ...
  return {
    ...
    getStyle(theme): StyleSpecification {
      return {
        ...
        layers: [
          { id: 'asol-background', type: 'background', paint: { 'background-color': theme === 'dark' ? (options.darkBackground ?? '#17191c') : (options.lightBackground ?? '#eef1f4') } },
          { id: 'asol-base-map', type: 'raster', source: 'base' },
        ],
      };
    },
  };

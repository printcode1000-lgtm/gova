...
import type { FeaturedMarqueeRecord } from "@/features/advertisements/entities/featured-marquee.entity";
...
export function SuperAdminFeaturedMarqueePage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      const saved = await featuredMarqueeApiService.save(session, {
        productIds,
      });
      setRecord(saved);

...
import type { ProductPreviewMode } from "./types";
...
export function FieldsGrid({ children }: { children: React.ReactNode }) {
  return <div className="grid gap-3 sm:grid-cols-2">{children}</div>;
}

export function initialValue(mode: ProductPreviewMode, sample: string) {
  return mode === "new" ? "" : sample;
}

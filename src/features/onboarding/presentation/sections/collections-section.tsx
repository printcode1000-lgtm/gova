          ...
          {showForm ? (
            <div id="onboarding.sections.collections-section.div.2" className="space-y-6 animate-in slide-in-from-top-2 duration-200">
              ...
              <div id="onboarding.sections.collections-section.div.7" className="flex justify-end gap-3 pt-4 border-t">
                <Button id="onboarding.sections.collections-section.button" variant="outline" onClick={() => setShowForm(false)}>
                  {t('onboarding.common.cancel')}
                </Button>
                <Button id="onboarding.sections.collections-section.button.2" onClick={handleCreateCollection} disabled={!newCollection.name?.trim()}>
            ...
            <div id="onboarding.sections.collections-section.div.8" className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <Button id="onboarding.sections.collections-section.button.3" onClick={() => setShowForm(true)} className="gap-2">
            ...
            <div id="onboarding.sections.collections-section.div.10" className="space-y-4">
              ...
              <Button id="onboarding.sections.collections-section.button.4" variant="outline" onClick={() => setShowForm(true)} className="w-full gap-2">

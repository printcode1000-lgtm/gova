...
export function ChatMessagePreferencesSection({
  ...
  return (
    <div
      id="features-settings-presentation-chatmessagepreferencessection-div-1-gq7fng"
      className="grid gap-3"
    >
      <SettingsToggleRow
        id="features-settings-presentation-chatmessagepreferencessection-settingstogglerow-2-p3vb4f"
      ...
      />
      <SettingsToggleRow
        id="features-settings-presentation-chatmessagepreferencessection-settingstogglerow-3-zmypyr"
      ...
      {state.preferencesAvailable ? null : (
        <p
          id="features-settings-presentation-chatmessagepreferencessection-text-4-uh8mzn"
          className="rounded-lg bg-surface px-3 py-2 text-sm text-on-surface-variant"
        >

  ...
  return (
    <main {...uiAttributes({ uid: "contact.contact-page-content.main.2-p1s8sE", id: "contact.contact-page-content.main.2" })} id="contact.contact-page-content.main" className="mx-auto w-full max-w-6xl space-y-8 px-4 py-8" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <div {...uiAttributes({ uid: "contact.contact-page-content.div.12-n6LPZD", id: "contact.contact-page-content.div.12" })} id="contact.contact-page-content.div.3" className="grid gap-6 lg:grid-cols-[1.35fr_.65fr]">
        <form {...uiAttributes({ uid: "contact-submit-no73V8", id: "contact-submit", kind: "action", interaction: { type: "tap" }, simulation: { kind: "event", id: "contact-submit" } })} onSubmit={submit} className="space-y-5 rounded-3xl border border-outline/30 bg-surface p-6 shadow-sm md:p-8">
          ...
          <div {...uiAttributes({ uid: "contact.contact-page-content.div.14-90LjKG", id: "contact.contact-page-content.div.14" })} id="contact.contact-page-content.div.5" className="grid gap-4 md:grid-cols-2">
            ...
            <Field id="contact.contact-page-content.field.4" icon={faBriefcase} label={c.service}><select {...uiAttributes({ uid: "contact.contact-page-content.select.2-QRebD5", id: "contact.contact-page-content.select.2" })} id="contact.contact-page-content.select" value={form.service} onChange={(event) => set("service", event.target.value)}>{serviceValues.map((value, index) => <option key={value} {...uiAttributes({ uid: "contact.contact-page-content.option-O0lZHc", id: "contact.contact-page-content.option" , instance: createOpaqueUiInstanceId("iter-caff302e10", String(value))})} value={value}>{c.options[index]}</option>)}</select></Field>
          </div>
        ...
        <aside {...uiAttributes({ uid: "contact.contact-page-content.aside.2-U8n6KP", id: "contact.contact-page-content.aside.2" })} id="contact.contact-page-content.aside" className="space-y-5">
          <section {...uiAttributes({ uid: "contact.contact-page-content.section.7-3DULBL", id: "contact.contact-page-content.section.7" })} id="contact.contact-page-content.section.2" className="rounded-3xl border border-outline/30 bg-surface p-6 shadow-sm">
            ...
            <div {...uiAttributes({ uid: "contact.contact-page-content.div.15-Mb9JJ3", id: "contact.contact-page-content.div.15" })} id="contact.contact-page-content.div.6" className="mt-5 flex flex-wrap gap-3">{SOCIALS.map((social) => <a key={social.label} {...uiAttributes({ uid: "contact-channel-GY1n2A", id: "contact-channel", kind: "item", interaction: { type: "tap" }, simulation: { kind: "list-item", id: "contact-channel" } , instance: createOpaqueUiInstanceId("iter-3b3a7741a7", String(social.label))})} href={social.href} target="_blank" rel="noreferrer" aria-label={social.label} className="flex h-11 w-11 items-center justify-center rounded-xl bg-primary/10 text-xl text-primary transition-transform"><FontAwesomeIcon icon={social.icon} /></a>)}</div>
          </section>
      ...
      <section {...uiAttributes({ uid: "contact.contact-page-content.section.9-nSUIl0", id: "contact.contact-page-content.section.9" })} id="contact.contact-page-content.section.4">
        ...
        <div {...uiAttributes({ uid: "contact.contact-page-content.div.16-bz9JtB", id: "contact.contact-page-content.div.16" })} id="contact.contact-page-content.div.7" className="grid gap-4 md:grid-cols-3">{c.services.map((item, index) => <div key={item} {...uiAttributes({ uid: "contact.contact-page-content.div.17-oQ5sEN", id: "contact.contact-page-content.div.17" , instance: createOpaqueUiInstanceId("iter-2f7c66b395", String(item))})} className="rounded-2xl border border-outline/30 bg-surface p-6"><div {...uiAttributes({ uid: "contact.contact-page-content.div.18-S3Rcb8", id: "contact.contact-page-content.div.18" , instance: createOpaqueUiInstanceId("iter-2f7c66b395", String(item))})} className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-secondary/15 text-xl text-secondary"><FontAwesomeIcon icon={serviceIcons[index]} /></div><h3 {...uiAttributes({ uid: "contact.contact-page-content.h3-V7d4hr", id: "contact.contact-page-content.h3" , instance: createOpaqueUiInstanceId("iter-2f7c66b395", String(item))})} className="font-bold">{item}</h3></div>)}</div>
      </section>
      ...
      <section {...uiAttributes({ uid: "contact.contact-page-content.section.10-Jl2QTX", id: "contact.contact-page-content.section.10" })} id="contact.contact-page-content.section.5" className="rounded-3xl border border-outline/30 bg-surface p-6 md:p-8">
        ...
        <div {...uiAttributes({ uid: "contact.contact-page-content.div.19-tCM1AV", id: "contact.contact-page-content.div.19" })} id="contact.contact-page-content.div.8" className="space-y-3">{c.faqs.map(([question, answer], index) => <details key={question} {...uiAttributes({ uid: "contact.contact-page-content.details-5ZsaOy", id: "contact.contact-page-content.details" , instance: createOpaqueUiInstanceId("iter-bc7c311183", String(question))})} className="group rounded-xl bg-surface-container p-4"><summary {...uiAttributes({ uid: "contact.contact-page-content.summary-CJ4naH", id: "contact.contact-page-content.summary" , instance: createOpaqueUiInstanceId("iter-bc7c311183", String(question))})} className="flex list-none items-center gap-3 font-semibold"><span {...uiAttributes({ uid: "contact.contact-page-content.span-ISfVH6", id: "contact.contact-page-content.span" , instance: createOpaqueUiInstanceId("iter-bc7c311183", String(question))})} className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary"><FontAwesomeIcon icon={faQuestionCircle} /></span><span {...uiAttributes({ uid: "contact.contact-page-content.span.2-l3LNpB", id: "contact.contact-page-content.span.2" , instance: createOpaqueUiInstanceId("iter-bc7c311183", String(question))})} className="flex-1">{question}</span><FontAwesomeIcon icon={faChevronDown} className="text-primary transition-transform group-open:rotate-180" /></summary><p {...uiAttributes({ uid: "contact.contact-page-content.p.9-Bc0IAf", id: "contact.contact-page-content.p.9" , instance: createOpaqueUiInstanceId("iter-bc7c311183", String(question))})} className="mt-4 border-t border-outline/20 pt-4 leading-8 text-on-surface-variant">{answer}</p></details>)}</div>
      </section>

...
function IndicatorCard(props: {
  ...
  return (
    <div {...uiAttributes({ uid: "google-play-console.android-release-paths-terminal.div.2-v3aOtF", id: "google-play-console.android-release-paths-terminal.div.2", instance: props.instance })} id={props.id} className={props.className ?? ""}>
      <div {...uiAttributes({ uid: "google-play-console.android-release-paths-terminal.div.3-OP0rLm", id: "google-play-console.android-release-paths-terminal.div.3", instance: props.instance })} className="min-w-0 rounded-md border bg-surface p-3">
        <div {...uiAttributes({ uid: "google-play-console.android-release-paths-terminal.div.4-6ATR9Y", id: "google-play-console.android-release-paths-terminal.div.4", instance: props.instance })} className="text-xs text-on-surface-variant">{props.label}</div>
        <div {...uiAttributes({ uid: "google-play-console.android-release-paths-terminal.div.5-v3D2MM", id: "google-play-console.android-release-paths-terminal.div.5", instance: props.instance })} className="mt-1 text-sm font-semibold break-words sm:text-base" dir="ltr">
          {props.value || "—"}
        </div>
        <p {...uiAttributes({ uid: "google-play-console.android-release-paths-terminal.p-3LX3eh", id: "google-play-console.android-release-paths-terminal.p", instance: props.instance })} className="mt-1 text-[11px] text-on-surface-variant break-words">{props.help}</p>
      </div>
    </div>
  );
}
      ...
      >
        <div {...uiAttributes({ uid: "google-play-console.android-release-paths-terminal.div.6-Qb02JM", id: "google-play-console.android-release-paths-terminal.div.6" })} id="google-play-console.android-release-paths-terminal.div" className="grid grid-cols-1 gap-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5">
          <IndicatorCard id="google-play-console.android-release-paths-terminal.indicator-card"
            instance={createUiInstanceId("status")}

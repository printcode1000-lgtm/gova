        ...
        <section {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.section.5-T9Q0p7", id: "catalog-studio.catalog-studio-page.section.5" })} id="catalog-studio.catalog-studio-page.section" className="grid gap-4 xl:grid-cols-[1fr_420px]">
          <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.63-pv8kJe", id: "catalog-studio.catalog-studio-page.div.63" })} id="catalog-studio.catalog-studio-page.div.9" className="space-y-4">
            <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.64-GXM9av", id: "catalog-studio.catalog-studio-page.div.64" })} id="catalog-studio.catalog-studio-page.div.10" className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              {[
                ...
                <div key={String(label)} {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.65-9EZ1rZ", id: "catalog-studio.catalog-studio-page.div.65" , instance: createOpaqueUiInstanceId("iter-8c24eb8608", String(String(label)))})} className="rounded-2xl border bg-card p-4">
                  <p {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.p.16-NCs8oU", id: "catalog-studio.catalog-studio-page.p.16" , instance: createOpaqueUiInstanceId("iter-01ae8e4640", String(String(label)))})} className="text-sm text-muted-foreground">{label}</p>
                  <p {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.p.17-QZ53LL", id: "catalog-studio.catalog-studio-page.p.17" , instance: createOpaqueUiInstanceId("iter-bb8f08e81d", String(String(label)))})} className="mt-2 text-2xl font-bold">{value}</p>
                </div>
              ))}
            </div>
            <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.66-0AseBQ", id: "catalog-studio.catalog-studio-page.div.66" })} id="catalog-studio.catalog-studio-page.div.11" className="rounded-2xl border bg-card p-5">
              ...
              <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.67-RILT0i", id: "catalog-studio.catalog-studio-page.div.67" })} id="catalog-studio.catalog-studio-page.div.12" className="mt-4 grid gap-2 md:grid-cols-2 xl:grid-cols-3">
                {snapshot.files.map((file) => (
                  <button
                    key={file.path} {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.button.10-dTGpa1", id: "catalog-studio.catalog-studio-page.button.10" , instance: createOpaqueUiInstanceId("iter-874bc0f4ce", String(file.path))})}
                    type="button"
                    onClick={() => {
                  ...
                  >
                    ...
                    <span {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.span.16-GK5mrO", id: "catalog-studio.catalog-studio-page.span.16" , instance: createOpaqueUiInstanceId("iter-6f1f986167", String(file.path))})} className="min-w-0 flex-1">
                      <span {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.span.17-CMSQ9X", id: "catalog-studio.catalog-studio-page.span.17" , instance: createOpaqueUiInstanceId("iter-86d839722f", String(file.path))})} className="block truncate font-mono text-xs" dir="ltr">{file.path}</span>
                      <span {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.span.18-m7qTBM", id: "catalog-studio.catalog-studio-page.span.18" , instance: createOpaqueUiInstanceId("iter-43cf30a5ca", String(file.path))})} className="text-xs text-muted-foreground">{file.itemCount} عنصر {file.readOnly ? "• قراءة فقط" : ""}</span>
                    </span>
                  </button>
                ))}
              </div>
          ...
          <aside {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.aside.6-e0XHP3", id: "catalog-studio.catalog-studio-page.aside.6" })} id="catalog-studio.catalog-studio-page.aside" className="space-y-4">
            <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.68-bcIZ04", id: "catalog-studio.catalog-studio-page.div.68" })} id="catalog-studio.catalog-studio-page.div.13" className="rounded-2xl border bg-card p-5">
              ...
              <pre {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.pre-1DEHkV", id: "catalog-studio.catalog-studio-page.pre" })} className="mt-4 max-h-96 overflow-auto rounded-xl bg-slate-950 p-3 text-xs text-slate-100" dir="ltr">{snapshot.validation.output}</pre>
            </div>
        ...
        <section {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.section.6-WDxUe3", id: "catalog-studio.catalog-studio-page.section.6" })} id="catalog-studio.catalog-studio-page.section.2" className="grid min-h-[72vh] gap-4 lg:grid-cols-[250px_minmax(0,1fr)_360px]">
          <aside {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.aside.7-o41YBh", id: "catalog-studio.catalog-studio-page.aside.7" })} id="catalog-studio.catalog-studio-page.aside.2" className="rounded-2xl border bg-card p-3">
            ...
            <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.71-KL7f03", id: "catalog-studio.catalog-studio-page.div.71" })} id="catalog-studio.catalog-studio-page.div.16" className="space-y-1">
              {groupFiles.map((file) => (
                <button
                  key={file.path} {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.button.12-Ozx719", id: "catalog-studio.catalog-studio-page.button.12" , instance: createOpaqueUiInstanceId("iter-863b9dbda2", String(file.path))})}
                  type="button"
                ...
                >
                  ...
                  <span {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.span.22-WVvF82", id: "catalog-studio.catalog-studio-page.span.22" , instance: createOpaqueUiInstanceId("iter-9ee46ce78a", String(file.path))})} className="min-w-0 flex-1 truncate text-xs" dir="ltr">{file.path.split("/").at(-1)}</span>
                  {drafts[file.path] ? <span {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.span.23-oVQ9Ea", id: "catalog-studio.catalog-studio-page.span.23" , instance: createOpaqueUiInstanceId("iter-565edb32f9", String(file.path))})} className="h-2 w-2 rounded-full bg-amber-400" /> : null}
                </button>
              ))}
            </div>
          </aside>
          ...
          <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.72-DnZEm5", id: "catalog-studio.catalog-studio-page.div.72" })} id="catalog-studio.catalog-studio-page.div.17" className="min-w-0 space-y-3">
              ...
              <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.74-bffU9X", id: "catalog-studio.catalog-studio-page.div.74" })} id="catalog-studio.catalog-studio-page.div.19" className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.76-8Meuld", id: "catalog-studio.catalog-studio-page.div.76" })} id="catalog-studio.catalog-studio-page.div.21" className="flex flex-wrap gap-1">
                  {(["structured", "raw", "relations", "diff"] as EditorMode[]).map((editorMode) => (
                    <button
                      key={editorMode} {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.button.13-5N6XHI", id: "catalog-studio.catalog-studio-page.button.13" , instance: createOpaqueUiInstanceId("iter-dbd8218eda", String(editorMode))})}
                      type="button"
                  ...
                  <table {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.table.2-yd7C1Q", id: "catalog-studio.catalog-studio-page.table.2" })} id="catalog-studio.catalog-studio-page.table" className="w-full min-w-[850px] text-sm">
                    ...
                    <tbody {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.tbody.2-tbTn1y", id: "catalog-studio.catalog-studio-page.tbody.2" })} id="catalog-studio.catalog-studio-page.tbody">
                      {filteredRows.map(({ item, index }) => {
                        ...
                        return (
                          <tr
                            key={`${identityFor(item)}:${index}`} {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.tr.3-j7L10i", id: "catalog-studio.catalog-studio-page.tr.3" , instance: createOpaqueUiInstanceId("iter-cd25de81d0", String(`${identityFor(item)}:${index}`))})}
                          ...
                          >
                            <td {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.td-3KaLQQ", id: "catalog-studio.catalog-studio-page.td" , instance: createOpaqueUiInstanceId("iter-826e0d56f4", String(`${identityFor(item)}:${index}`))})} className="p-2">
                              <span {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.span.24-VXLei9", id: "catalog-studio.catalog-studio-page.span.24" , instance: createOpaqueUiInstanceId("iter-ece3caa2d1", String(`${identityFor(item)}:${index}`))})}
                                data-drag-handle
                                draggable
                            ...
                            <td {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.td.2-22d2bB", id: "catalog-studio.catalog-studio-page.td.2" , instance: createOpaqueUiInstanceId("iter-0bc3046187", String(`${identityFor(item)}:${index}`))})} className="p-2 font-mono">{String(display?.order ?? "—")}</td>
                            <td {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.td.3-9kOGH7", id: "catalog-studio.catalog-studio-page.td.3" , instance: createOpaqueUiInstanceId("iter-cde4841a84", String(`${identityFor(item)}:${index}`))})} className="p-2 font-mono text-xs" dir="ltr">{identityFor(item)}</td>
                            <td {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.td.4-cYLns1", id: "catalog-studio.catalog-studio-page.td.4" , instance: createOpaqueUiInstanceId("iter-d7ca9d340f", String(`${identityFor(item)}:${index}`))})} className="max-w-52 truncate p-2">{nameFor(item, "ar") || String(item.value ?? "—")}</td>
                            <td {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.td.5-XG184m", id: "catalog-studio.catalog-studio-page.td.5" , instance: createOpaqueUiInstanceId("iter-48f990be22", String(`${identityFor(item)}:${index}`))})} className="max-w-52 truncate p-2" dir="ltr">{nameFor(item, "en") || String(item.kind ?? "—")}</td>
                            <td {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.td.6-S2BT8W", id: "catalog-studio.catalog-studio-page.td.6" , instance: createOpaqueUiInstanceId("iter-df0a04e9c8", String(`${identityFor(item)}:${index}`))})} className="p-2 text-center">{display?.hidden === true ? <EyeOff className="mx-auto h-4 w-4 text-red-600" /> : <Eye className="mx-auto h-4 w-4 text-emerald-600" />}</td>
                            <td {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.td.7-LLy7jO", id: "catalog-studio.catalog-studio-page.td.7" , instance: createOpaqueUiInstanceId("iter-99c4a7080b", String(`${identityFor(item)}:${index}`))})} className="max-w-56 truncate p-2 text-xs" dir="ltr">{String(item.imagePath ?? item.image ?? item.optionFile ?? item.column ?? "—")}</td>
                            <td {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.td.8-Qs3ft4", id: "catalog-studio.catalog-studio-page.td.8" , instance: createOpaqueUiInstanceId("iter-703457b4f1", String(`${identityFor(item)}:${index}`))})} className="p-2">
                              <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.81-aehp2K", id: "catalog-studio.catalog-studio-page.div.81" , instance: createOpaqueUiInstanceId("iter-8a404eaaf9", String(`${identityFor(item)}:${index}`))})} className="flex justify-center gap-1">
                                <button {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.button.14-8U4Lb3", id: "catalog-studio.catalog-studio-page.button.14" , instance: createOpaqueUiInstanceId("iter-6341457a7c", String(`${identityFor(item)}:${index}`))})} type="button" aria-label="لأعلى" onClick={(event) => { event.stopPropagation(); reorder(index, Math.max(0, index - 1)); }}><ArrowUp className="h-4 w-4" /></button>
                                <button {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.button.15-5562RD", id: "catalog-studio.catalog-studio-page.button.15" , instance: createOpaqueUiInstanceId("iter-3a0e334937", String(`${identityFor(item)}:${index}`))})} type="button" aria-label="لأسفل" onClick={(event) => { event.stopPropagation(); reorder(index, Math.min(selectedItems.length - 1, index + 1)); }}><ArrowDown className="h-4 w-4" /></button>
                                <button {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.button.16-H0G4AI", id: "catalog-studio.catalog-studio-page.button.16" , instance: createOpaqueUiInstanceId("iter-8c2c0121d5", String(`${identityFor(item)}:${index}`))})} type="button" aria-label="نسخ" onClick={(event) => { event.stopPropagation(); cloneItemAt(index); }}><Copy className="h-4 w-4" /></button>
                              </div>
                            </td>
                          </tr>
                        );
            ...
            {mode === "diff" ? (
              <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.85-G9GXmp", id: "catalog-studio.catalog-studio-page.div.85" })} id="catalog-studio.catalog-studio-page.div.28" className="grid gap-3 xl:grid-cols-2">
                <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.86-6XoQmD", id: "catalog-studio.catalog-studio-page.div.86" })} id="catalog-studio.catalog-studio-page.div.29" className="min-w-0"><p {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.p.25-Q5GdRQ", id: "catalog-studio.catalog-studio-page.p.25" })} id="catalog-studio.catalog-studio-page.p.6" className="mb-2 text-sm font-bold">قبل</p><pre {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.pre.2-B1oOnl", id: "catalog-studio.catalog-studio-page.pre.2" })} className="h-[64vh] overflow-auto rounded-2xl bg-slate-950 p-4 text-xs text-slate-100" dir="ltr">{selectedFile?.content}</pre></div>
                <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.87-B5PH20", id: "catalog-studio.catalog-studio-page.div.87" })} id="catalog-studio.catalog-studio-page.div.30" className="min-w-0"><p {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.p.26-eAgP67", id: "catalog-studio.catalog-studio-page.p.26" })} id="catalog-studio.catalog-studio-page.p.7" className="mb-2 text-sm font-bold">المسودة</p><pre {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.pre.3-ZTHcf7", id: "catalog-studio.catalog-studio-page.pre.3" })} className="h-[64vh] overflow-auto rounded-2xl bg-slate-950 p-4 text-xs text-emerald-200" dir="ltr">{selectedContent}</pre></div>
              </div>
            ) : null}
          </div>
                ...
                <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.95-2XBT9J", id: "catalog-studio.catalog-studio-page.div.95" })} id="catalog-studio.catalog-studio-page.div.38" className="grid gap-3">
                  {primitiveKeys.filter((key) => key in currentItem).map((key) => {
                    ...
                    if (typeof value === "boolean") {
                      return <div key={key} {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.96-6IAV1B", id: "catalog-studio.catalog-studio-page.div.96" , instance: createOpaqueUiInstanceId("iter-89eb020ab4", String(key))})} className="flex items-center justify-between rounded-lg border p-2"><span {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.span.29-g4yZdE", id: "catalog-studio.catalog-studio-page.span.29" , instance: createOpaqueUiInstanceId("iter-89eb020ab4", String(key))})} className="font-mono text-xs" dir="ltr">{key}</span><Switch ui={{ uid: "catalog-studio.catalog-studio-page.switch.4-G7R913", id: "catalog-studio.catalog-studio-page.switch.4" , instance: createOpaqueUiInstanceId("iter-89eb020ab4", String(key))}} checked={value} onCheckedChange={(checked) => updatePrimitive(key, checked)} /></div>;
                    }
                    if (typeof value === "object" && value !== null) return null;
                    return <label key={key} {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.label.9-QSHho2", id: "catalog-studio.catalog-studio-page.label.9" , instance: createOpaqueUiInstanceId("iter-4337fd9006", String(key))})} className="text-sm"><span {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.span.30-R5D6Jj", id: "catalog-studio.catalog-studio-page.span.30" , instance: createOpaqueUiInstanceId("iter-4337fd9006", String(key))})} className="mb-1 block font-mono text-xs" dir="ltr">{key}</span><input {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.input.11-PHkI89", id: "catalog-studio.catalog-studio-page.input.11" , instance: createOpaqueUiInstanceId("iter-4337fd9006", String(key))})} dir="ltr" value={value === null ? "" : String(value ?? "")} onChange={(event) => updatePrimitive(key, event.target.value)} className="w-full rounded-lg border bg-background px-3 py-2 text-sm" /></label>;
                  })}
                </div>
          ...
          <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.102-RVa2N4", id: "catalog-studio.catalog-studio-page.div.102" })} id="catalog-studio.catalog-studio-page.div.44" className="grid gap-4 xl:grid-cols-[380px_1fr]">
            ...
            <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.103-7VPBw5", id: "catalog-studio.catalog-studio-page.div.103" })} id="catalog-studio.catalog-studio-page.div.45" className="grid max-h-[72vh] gap-3 overflow-auto sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
              {filteredImages.map((image) => (
                <article key={image.path} {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.article-ES7OIg", id: "catalog-studio.catalog-studio-page.article" , instance: createOpaqueUiInstanceId("iter-5dc5b43384", String(image.path))})} className="overflow-hidden rounded-2xl border bg-card">
                  <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.104-D90ONG", id: "catalog-studio.catalog-studio-page.div.104" , instance: createOpaqueUiInstanceId("iter-562de22183", String(image.path))})} className="aspect-[4/3] bg-surface-bright bg-contain bg-center bg-no-repeat" style={{ backgroundImage: `url("${image.publicUrl.replaceAll('"', "%22")}")` }} />
                  <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.105-z3FITI", id: "catalog-studio.catalog-studio-page.div.105" , instance: createOpaqueUiInstanceId("iter-0ee9a2ca63", String(image.path))})} className="space-y-2 p-3">
                    <p {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.p.33-3mcAOT", id: "catalog-studio.catalog-studio-page.p.33" , instance: createOpaqueUiInstanceId("iter-1e80406d38", String(image.path))})} className="truncate font-mono text-xs" aria-label={image.path} dir="ltr">{image.path}</p>
                    <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.106-2C9ajV", id: "catalog-studio.catalog-studio-page.div.106" , instance: createOpaqueUiInstanceId("iter-e5c9d9bf04", String(image.path))})} className="flex flex-wrap gap-1 text-[11px]"><span {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.span.34-9RhYaB", id: "catalog-studio.catalog-studio-page.span.34" , instance: createOpaqueUiInstanceId("iter-e5c9d9bf04", String(image.path))})} className="rounded bg-muted px-2 py-1">{humanSize(image.size)}</span><span {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.span.35-18GsX1", id: "catalog-studio.catalog-studio-page.span.35" , instance: createOpaqueUiInstanceId("iter-e5c9d9bf04", String(image.path))})} className={cn("rounded px-2 py-1", image.references.length ? "bg-emerald-100 text-emerald-800" : "bg-amber-100 text-amber-800")}>{image.references.length} مرجع</span></div>
                    <p {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.p.34-VlRh05", id: "catalog-studio.catalog-studio-page.p.34" , instance: createOpaqueUiInstanceId("iter-a7a5b97234", String(image.path))})} className="truncate font-mono text-[10px] text-muted-foreground" dir="ltr">SHA {image.hash.slice(0, 16)}…</p>
                    {image.references.length ? <details {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.details-iFTH3j", id: "catalog-studio.catalog-studio-page.details" , instance: createOpaqueUiInstanceId("iter-a039d9bf11", String(image.path))})} className="text-xs"><summary {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.summary-50QeUB", id: "catalog-studio.catalog-studio-page.summary" , instance: createOpaqueUiInstanceId("iter-a039d9bf11", String(image.path))})} className="">العلاقات</summary><div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.107-FEp81l", id: "catalog-studio.catalog-studio-page.div.107" , instance: createOpaqueUiInstanceId("iter-a039d9bf11", String(image.path))})} className="mt-1 space-y-1">{image.references.map((reference) => <p key={reference} {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.p.35-RnAq75", id: "catalog-studio.catalog-studio-page.p.35" , instance: composeUiInstanceId(createOpaqueUiInstanceId("iter-a039d9bf11", String(reference)), createOpaqueUiInstanceId("iter-08be5b8ebe", String(reference)))})} className="break-all font-mono" dir="ltr">{reference}</p>)}</div></details> : null}
                    <Button ui={{ uid: "catalog-studio.catalog-studio-page.button.17-NWcOl4", id: "catalog-studio.catalog-studio-page.button.17" , instance: createOpaqueUiInstanceId("iter-0eb81b9047", String(image.path))}} variant="outline" size="sm" className="w-full" disabled={image.references.length > 0 || Boolean(busy)} onClick={() => stageImageTrash(image.path)}><Trash2 className="me-1 h-4 w-4" /> نقل للسلة</Button>
                  </div>
                </article>
              ))}
            </div>
        ...
        <section {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.section.8-4nwSGW", id: "catalog-studio.catalog-studio-page.section.8" })} id="catalog-studio.catalog-studio-page.section.4" className="grid gap-4 xl:grid-cols-[1fr_460px]">
          ...
          <aside {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.aside.10-DCsV8w", id: "catalog-studio.catalog-studio-page.aside.10" })} id="catalog-studio.catalog-studio-page.aside.5" className="space-y-4">
            <div {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.div.113-sO8hQa", id: "catalog-studio.catalog-studio-page.div.113" })} id="catalog-studio.catalog-studio-page.div.49" className="rounded-2xl border bg-card p-5">
              ...
              <pre {...uiAttributes({ uid: "catalog-studio.catalog-studio-page.pre.4-Zv8UM1", id: "catalog-studio.catalog-studio-page.pre.4" })} className="mt-4 max-h-[48vh] overflow-auto rounded-xl bg-slate-950 p-3 text-xs text-slate-100" dir="ltr">{validation?.output ?? snapshot.validation.output}</pre>
            </div>

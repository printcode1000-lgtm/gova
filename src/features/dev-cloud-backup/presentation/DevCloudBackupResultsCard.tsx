...
export function DevCloudBackupResultsCard({
  ...
  return (
    <div id="dev-cloud-backup.dev-cloud-backup-results-card.div" className="rounded-md border bg-surface p-4">
      <div id="dev-cloud-backup.dev-cloud-backup-results-card.div.2" className="flex items-center gap-2 font-semibold">
      ...
      {!diff && !updatedZip && !preview ? (
        <div id="dev-cloud-backup.dev-cloud-backup-results-card.div.3" className="mt-4 rounded-md border border-blue-200 bg-blue-50 p-3 text-sm text-blue-800">
          استخدم أزرار فحص أو مقارنة أو تحديث من قائمة النسخ المحفوظة. لا توجد أي عملية يدوية أو رفع ملف من هذه الصفحة.
        </div>
      ) : null}
      {diff ? (
        <div id="dev-cloud-backup.dev-cloud-backup-results-card.div.4" className="mt-4 space-y-3 rounded-md border bg-surface p-3 text-sm">
          <div id="dev-cloud-backup.dev-cloud-backup-results-card.div.5" className="flex flex-wrap items-center justify-between gap-2">
            <div id="dev-cloud-backup.dev-cloud-backup-results-card.div.6" className="font-semibold">نتيجة المقارنة</div>
            <span id="dev-cloud-backup.dev-cloud-backup-results-card.span"
          ...
          <div id="dev-cloud-backup.dev-cloud-backup-results-card.div.7" className="grid gap-2 sm:grid-cols-4">
      ...
      {updatedZip ? (
        <div id="dev-cloud-backup.dev-cloud-backup-results-card.div.8" className="mt-4 grid gap-2 rounded-md border border-green-200 bg-green-50 p-3 text-sm text-green-700">
          ...
          <Button id="dev-cloud-backup.dev-cloud-backup-results-card.button"
            type="button"
            size="sm"
            variant="outline"
      ...
      {preview ? (
        <div id="dev-cloud-backup.dev-cloud-backup-results-card.div.9" className="mt-4 space-y-3">
          <div id="dev-cloud-backup.dev-cloud-backup-results-card.div.10" className="grid gap-2 rounded-md bg-muted p-3 text-sm">
          ...
          {preview.warnings.length ? (
            <div id="dev-cloud-backup.dev-cloud-backup-results-card.div.11" className="rounded-md border border-amber-200 bg-amber-50 p-3 text-sm text-amber-800">

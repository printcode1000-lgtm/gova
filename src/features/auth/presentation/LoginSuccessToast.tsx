...
export function LoginSuccessToast() {
  ...
  return (
    <div id='features-auth-presentation-loginsuccesstoast-div-1-cwxqgs'
      role="status"
      aria-live="polite"
    ...
    >
      <CheckCircle2 id='features-auth-presentation-loginsuccesstoast-checkcircle2-2-3tqnnk' className="mt-0.5 h-5 w-5 shrink-0 text-success" />
      <div id='features-auth-presentation-loginsuccesstoast-div-3-acec0j' className="min-w-0">
        <p id='features-auth-presentation-loginsuccesstoast-text-4-juiuyt' className="text-sm font-bold">{title}</p>
        <p id='features-auth-presentation-loginsuccesstoast-text-5-n0zfbc' className="text-xs">{message}</p>
      </div>
    </div>
  );
}

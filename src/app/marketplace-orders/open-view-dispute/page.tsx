    ...
    <div className="w-full asol-canvas min-h-screen p-4 text-on-surface">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between border-b border-outline-variant/30 pb-4">
          <h1 className="text-xl font-bold text-primary">{t('marketplaceOrders.openViewDispute.title')}</h1>
...
<span className="font-label-sm text-label-sm">{t('marketplaceOrders.openViewDispute.orders')}</span>
<ChevronRight className="text-sm"  />
<span className="font-label-sm text-label-sm">{t('marketplaceOrders.openViewDispute.orderId')}</span>
<ChevronRight className="text-sm"  />
<span className="font-label-sm text-label-sm text-primary">{t('marketplaceOrders.openViewDispute.dispute')}</span>
</nav>
<h1 className="font-headline-lg-mobile md:font-headline-xl text-headline-lg-mobile md:text-headline-xl text-primary">{t('marketplaceOrders.openViewDispute.caseId')}</h1>
</div>
...
<h2 className="font-headline-md text-headline-md text-on-surface">{t('marketplaceOrders.openViewDispute.caseDiscussion')}</h2>
<span className="text-label-sm font-label-sm text-on-surface-variant">{t('marketplaceOrders.openViewDispute.lastActivity')}</span>
</div>
...
<span className="font-label-md text-label-md text-on-surface">{t('marketplaceOrders.openViewDispute.buyerYou')}</span>
...
<span className="font-label-md text-label-md text-on-surface">{t('marketplaceOrders.openViewDispute.nexusComponents')}</span>
</div>
...
<textarea className="w-full min-h-[100px] p-4 rounded-xl border border-outline-variant bg-white focus:ring-2 focus:ring-primary focus:border-primary text-body-md font-body-md transition-all resize-none" placeholder={t('marketplaceOrders.openViewDispute.writeResponse')}></textarea>
...
<button className="bg-primary text-on-primary px-6 py-2 rounded-lg font-label-md hover:opacity-90 transition-opacity">
                                    {t('marketplaceOrders.openViewDispute.sendReply')}
                                </button>
</div>
</div>
</div>
...
<h3 className="font-headline-md text-headline-md text-on-surface">{t('marketplaceOrders.openViewDispute.caseSummary')}</h3>
<div className="space-y-stack-sm">
<label className="text-label-sm font-label-sm text-on-surface-variant uppercase">{t('marketplaceOrders.openViewDispute.disputeScope')}</label>
<div className="p-3 bg-surface-container-low rounded-lg flex items-center gap-3">
<Package className="text-primary"  />
<span className="font-body-md text-body-md text-on-surface">{t('marketplaceOrders.openViewDispute.specificItem')}</span>
</div>
</div>
<div className="space-y-stack-sm">
<label className="text-label-sm font-label-sm text-on-surface-variant uppercase">{t('marketplaceOrders.openViewDispute.reason')}</label>
<div className="p-3 bg-surface-container-low rounded-lg flex items-center gap-3">
<HelpCircle className="text-primary"  />
<span className="font-body-md text-body-md text-on-surface">{t('marketplaceOrders.openViewDispute.damagedDefective')}</span>
</div>
</div>
<div className="space-y-stack-sm">
<label className="text-label-sm font-label-sm text-on-surface-variant uppercase">{t('marketplaceOrders.openViewDispute.disputeAmount')}</label>
...
<FileText className=""  />
                            {t('marketplaceOrders.openViewDispute.viewOrderDetails')}
                        </button>
</div>
</div>
...
<div className="text-body-sm text-label-sm text-on-surface-variant">{t('marketplaceOrders.openViewDispute.platinumSeller')}</div>
</div>
</div>
<div className="flex gap-2">
<button className="flex-1 py-2 text-primary border border-primary rounded-lg font-label-sm hover:bg-primary-fixed transition-colors">{t('marketplaceOrders.openViewDispute.contactSeller')}</button>
</div>
</div>
...
<div className="font-label-sm text-label-sm leading-tight">{t('marketplaceOrders.openViewDispute.acceptPartial')}</div>
</div>
...
<XCircle className=""  />
<div className="font-label-sm text-label-sm leading-tight">{t('marketplaceOrders.openViewDispute.withdraw')}</div>
</div>
</div>
</div>
</div>

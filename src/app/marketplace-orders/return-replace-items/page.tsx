    ...
    <div className="w-full gova-canvas min-h-screen p-4 text-on-surface">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between border-b border-outline-variant/30 pb-4">
          <h1 className="text-xl font-bold text-primary">Return or Replace Items</h1>
...
<h1 className="font-headline-xl text-headline-xl text-primary mb-2">Return or Replace Items</h1>
<p className="font-body-md text-body-md text-on-surface-variant">Tell us what's wrong and choose how you'd like to proceed.</p>
</div>
...
<h2 className="font-headline-md text-headline-md">Request Type</h2>
</div>
...
<span className="font-bold text-primary">Return</span>
<span className="text-body-sm text-center text-on-surface-variant mt-1">Get a full refund to original payment method.</span>
</button>
...
<span className="font-bold text-on-surface-variant group-hover:text-primary">Replacement</span>
<span className="text-body-sm text-center text-on-surface-variant mt-1">We'll send a new item free of charge.</span>
</button>
</div>
</section>
...
<h2 className="font-headline-md text-headline-md">Select Items</h2>
</div>
...
<span className="text-label-sm px-2 py-0.5 bg-secondary-container/20 text-on-secondary-container rounded">Delivered</span>
...
<h2 className="font-headline-md text-headline-md">Details &amp; Evidence</h2>
</div>
<div className="space-y-stack-lg">
<div>
<label className="block font-label-md text-on-surface mb-2">Reason for Request</label>
...
<option>Performance not as expected</option>
</select>
</div>
<div>
<label className="block font-label-md text-on-surface mb-2">Detailed Description</label>
<textarea className="w-full p-4 border border-outline rounded-lg bg-white focus:ring-2 focus:ring-primary focus:border-primary transition-all resize-none" placeholder="Please provide specific details about the issue..." rows={4}></textarea>
</div>
<div>
<label className="block font-label-md text-on-surface mb-2">Upload Evidence (Images)</label>
...
<p className="text-body-sm text-on-surface-variant mt-1">PNG, JPG or WEBP (Max 10MB per file)</p>
...
<h3 className="font-headline-md text-headline-md mb-stack-md text-primary">Request Summary</h3>
...
<div className="flex justify-between">
<span className="text-on-surface-variant">Request Type</span>
<span className="font-bold text-primary" id="summary-type">Return</span>
</div>
</div>
<div className="py-stack-md">
<div className="flex justify-between items-baseline mb-stack-xs">
<span className="font-bold text-body-lg">Estimated Refund</span>
<span className="font-bold text-headline-md text-primary">$0.00</span>
</div>
<p className="text-body-sm text-on-surface-variant">Refund will be processed within 3-5 business days after inspection.</p>
</div>
...
<p className="text-center text-[11px] text-on-surface-variant mt-4 px-4">
                            By submitting, you agree to Gova's <a className="underline" href="#">Returns Policy</a> and <a className="underline" href="#">Terms of Service</a>.
                        </p>
</div>
...
<div>
<h4 className="font-bold text-body-md">Did you know?</h4>
<p className="text-body-sm mt-1 opacity-90">Replacements are often processed 48 hours faster than returns. Choose replacement for immediate project continuity.</p>
</div>
</div>
</div>
</div>

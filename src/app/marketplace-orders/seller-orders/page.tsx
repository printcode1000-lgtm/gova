    ...
    <div className="w-full gova-canvas min-h-screen p-4 text-on-surface">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between border-b border-outline-variant/30 pb-4">
          <h1 className="text-xl font-bold text-primary">Seller Orders</h1>
...
<div>
<h1 className="font-headline-lg-mobile md:font-headline-xl text-headline-lg-mobile md:text-headline-xl text-primary">Seller Orders</h1>
<p className="text-on-surface-variant mt-2">Manage your incoming demand and logistics pipeline.</p>
</div>
...
<div className="bg-surface-container-low px-stack-lg py-stack-md rounded-xl border border-outline-variant min-w-[140px]">
<div className="text-label-sm text-on-surface-variant">Active Orders</div>
...
<button className="px-stack-lg py-stack-md text-primary border-b-2 border-primary font-bold whitespace-nowrap">New <span className="ml-1 px-2 py-0.5 bg-primary-container text-white text-[10px] rounded-full">4</span></button>
<button className="px-stack-lg py-stack-md text-on-surface-variant hover:text-primary transition-colors whitespace-nowrap">Processing</button>
<button className="px-stack-lg py-stack-md text-on-surface-variant hover:text-primary transition-colors whitespace-nowrap">Ready for Shipping</button>
<button className="px-stack-lg py-stack-md text-on-surface-variant hover:text-primary transition-colors whitespace-nowrap">Returns</button>
</div>
...
<div className="absolute top-0 right-0 px-3 py-1 bg-tertiary-container text-on-tertiary-container text-[10px] font-bold rounded-bl-xl">CUSTOM REQUEST</div>
...
<div className="flex justify-between items-center">
<span className="text-body-sm text-on-surface-variant">Quantity:</span>
...
<span className="bg-primary-container/15 text-primary px-2 py-0.5 rounded text-[12px] font-bold">New Order</span>
</div>
</div>
<div className="mt-auto border-t border-outline-variant pt-stack-md flex justify-between items-center">
<div>
<div className="text-label-sm text-on-surface-variant">Payout</div>
<div className="text-body-lg font-bold text-primary">$4,200.00</div>
</div>
<button className="bg-primary text-white px-stack-lg py-2 rounded-lg font-bold hover:opacity-90 transition-opacity">View Details</button>
</div>
</div>
...
<div className="flex justify-between items-center">
<span className="text-body-sm text-on-surface-variant">Status:</span>
<span className="bg-primary-container/15 text-primary px-2 py-0.5 rounded text-[12px] font-bold">Awaiting Prep</span>
</div>
</div>
<div className="mt-auto border-t border-outline-variant pt-stack-md flex justify-between items-center">
<div>
...
<div className="flex justify-between items-center">
<span className="text-body-sm text-on-surface-variant">Status:</span>
<span className="bg-primary-container/15 text-primary px-2 py-0.5 rounded text-[12px] font-bold">Verification Pending</span>
</div>
</div>
<div className="mt-auto border-t border-outline-variant pt-stack-md flex justify-between items-center">
<div>
...
<div className="flex justify-between items-center">
<span className="text-body-sm text-on-surface-variant">Status:</span>
<span className="bg-primary-container/15 text-primary px-2 py-0.5 rounded text-[12px] font-bold">Processing</span>
</div>
</div>
<div className="mt-auto border-t border-outline-variant pt-stack-md flex justify-between items-center">
<div>

    ...
    <div className="w-full gova-canvas min-h-screen p-4 text-on-surface">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between border-b border-outline-variant/30 pb-4">
          <h1 className="text-xl font-bold text-primary">Prepare Items for Shipping</h1>
...
<div>
<h1 className="font-headline-xl text-headline-xl text-primary mb-2 hidden md:block">Prepare Items for Shipping</h1>
<h1 className="font-headline-lg-mobile text-headline-lg-mobile text-primary mb-2 md:hidden">Prepare Shipping</h1>
<p className="font-body-md text-body-md text-on-surface-variant max-w-2xl">
                    Manage your accepted orders and custom logistics requests. Ensure all items are properly packed and labeled before marking them ready for carrier pickup.
                </p>
</div>
...
<span className="font-label-sm text-label-sm text-on-secondary-container">Ready</span>
...
<HelpCircle className="text-[18px]"  /> All Items
            </button>
...
<HelpCircle className="text-[18px]"  /> Refrigerated
            </button>
<button className="bg-surface-container-high text-on-surface-variant px-4 py-2 rounded-full font-label-md text-label-md flex items-center gap-2 hover:bg-surface-container-highest transition-colors">
<Truck className="text-[18px]"  /> Special Vehicle
            </button>
</div>
...
<span className="bg-tertiary-container/15 text-tertiary-container px-3 py-1 rounded-full text-label-sm font-label-sm uppercase tracking-wider">Custom Request</span>
...
<span className="font-label-md text-label-md">Special Vehicle</span>
</div>
...
<span className="font-label-md text-label-md">Oversized</span>
</div>
</div>
...
<div className="flex justify-between items-start mb-2">
<span className="bg-primary-container/15 text-primary-container px-3 py-1 rounded-full text-label-sm font-label-sm">Standard Product</span>
...
<span className="font-label-md text-label-md">Refrigeration Required</span>
</div>
...
<div>
<h4 className="font-label-md text-label-md text-on-surface">Precision Tools</h4>
...
<span className="text-primary font-bold">Awaiting Prep</span>
</div>
...
<h3 className="font-headline-md text-headline-md text-on-surface">Bulk Textiles - Order #GOV-9902</h3>
</div>
...
<div>
<p className="text-label-sm text-on-surface-variant">Weight</p>
<p className="font-body-md text-body-md">1,200kg</p>
</div>
<div>
<p className="text-label-sm text-on-surface-variant">Packaging</p>
<p className="font-body-md text-body-md">Palletized</p>
</div>
<div>
<p className="text-label-sm text-on-surface-variant">Timeline</p>
<p className="font-body-md text-body-md text-secondary font-semibold italic">Priority</p>
</div>
</div>
</div>
<div className="flex flex-row md:flex-col gap-2 w-full md:w-auto">
<button className="flex-1 md:w-48 h-touch-target border border-primary text-primary rounded-xl font-label-md hover:bg-primary/5 transition-colors">Preparing</button>
<button className="flex-1 md:w-48 h-touch-target bg-primary text-on-primary rounded-xl font-label-md shadow-md">Mark Ready</button>
</div>
</div>
</div>
</main>

    ...
    <div className="w-full gova-canvas min-h-screen p-4 text-on-surface">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 flex items-center justify-between border-b border-outline-variant/30 pb-4">
          <h1 className="text-xl font-bold text-primary">Send Custom Request Price Offer</h1>
...
<span className="text-label-sm font-label-sm uppercase tracking-wider text-on-surface-variant">Request ID: #RQ-8821</span>
<div className="bg-secondary-container/15 text-on-secondary-container px-3 py-1 rounded-full text-label-sm font-label-sm">Active Request</div>
</div>
...
<span className="text-label-sm text-on-surface-variant block">Requested Qty</span>
<span className="font-bold text-on-surface">2,500 Units</span>
</div>
<div className="bg-surface-container-low p-stack-sm rounded-lg border border-outline-variant/50">
<span className="text-label-sm text-on-surface-variant block">Delivery By</span>
<span className="font-bold text-on-surface">Oct 12, 2024</span>
</div>
</div>
<div className="space-y-stack-sm">
<span className="text-label-sm font-label-sm text-on-surface-variant">Reference Attachments</span>
...
<div>
<p className="font-bold text-primary text-body-sm">Seller Guidance</p>
<p className="text-on-surface-variant text-body-sm">Competitive offers for this lane typically range between $42.00 - $48.50 per unit including logistics fees.</p>
</div>
</div>
</section>
...
<div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-stack-lg shadow-sm">
<h3 className="font-headline-md text-headline-md text-on-surface mb-stack-xl">Configure Your Price Offer</h3>
<form className="space-y-stack-lg" onInput={() => undefined}>
<div className="grid grid-cols-1 md:grid-cols-2 gap-stack-lg">
<div className="flex flex-col gap-stack-xs">
<label className="text-label-md font-label-md text-on-surface-variant">Unit Price (USD)</label>
...
<div className="flex flex-col gap-stack-xs">
<label className="text-label-md font-label-md text-on-surface-variant">Total Quantity</label>
...
<h4 className="text-label-md font-label-md text-primary uppercase">Additional Service Fees</h4>
<div className="grid grid-cols-1 md:grid-cols-2 gap-stack-lg">
<div className="flex flex-col gap-stack-xs">
<label className="text-label-md font-label-md text-on-surface-variant">Special Vehicle Fee</label>
<div className="relative">
<span className="absolute left-4 top-1/2 -translate-y-1/2 text-on-surface-variant">$</span>
...
<div className="flex flex-col gap-stack-xs">
<label className="text-label-md font-label-md text-on-surface-variant">Refrigeration Fee</label>
<div className="relative">
<span className="absolute left-4 top-1/2 -translate-y-1/2 text-on-surface-variant">$</span>
...
<div className="flex flex-col gap-stack-xs">
<label className="text-label-md font-label-md text-on-surface-variant">Standard Shipping</label>
<div className="relative">
<span className="absolute left-4 top-1/2 -translate-y-1/2 text-on-surface-variant">$</span>
...
<span className="font-bold text-on-surface">Total Offer Value</span>

...
const STYLE_DIRECTORY = path.join(process.cwd(), "product", "style");
...
function isValidSettings(value: unknown): value is ProductStyleSettings {
  ...
  return (
    ...
    (settings.components.images.order === undefined || (Number.isInteger(settings.components.images.order) && settings.components.images.order >= 1)) &&
    typeof settings.components?.rating?.visible === "boolean" &&
    (settings.components.rating.type === "stars" || settings.components.rating.type === "stars-comments") &&
    // Make order optional for backward compatibility
    (settings.components.rating.order === undefined || (Number.isInteger(settings.components.rating.order) && settings.components.rating.order >= 1)) &&
    ...
    (settings.components.price === undefined || (
      ...
      (settings.components.price.order === undefined || (Number.isInteger(settings.components.price.order) && settings.components.price.order >= 1))
    )) &&
    // Make order optional for backward compatibility
    (settings.components.order === undefined || (
      ...
      (settings.components.order.order === undefined || (Number.isInteger(settings.components.order.order) && settings.components.order.order >= 1))
    )) &&
    ...
    (settings.components.mainData === undefined || (
      ...
      (settings.components.mainData.order === undefined || (Number.isInteger(settings.components.mainData.order) && settings.components.mainData.order >= 1))
    )) &&
    ...
    (settings.components.specifications === undefined || (
      ...
      (settings.components.specifications.order === undefined || (Number.isInteger(settings.components.specifications.order) && settings.components.specifications.order >= 1))
    )) &&
    ...
    (settings.components.vehicleSpecs === undefined || (
      ...
      (settings.components.vehicleSpecs.order === undefined || (Number.isInteger(settings.components.vehicleSpecs.order) && settings.components.vehicleSpecs.order >= 1))
    )) &&
    ...
    (settings.components.propertySpecs === undefined || (
      ...
      (settings.components.propertySpecs.order === undefined || (Number.isInteger(settings.components.propertySpecs.order) && settings.components.propertySpecs.order >= 1))
    )) &&
    ...
    (settings.components.pharmacySpecs === undefined || (
      ...
      (settings.components.pharmacySpecs.order === undefined || (Number.isInteger(settings.components.pharmacySpecs.order) && settings.components.pharmacySpecs.order >= 1))
    ))
  );
}

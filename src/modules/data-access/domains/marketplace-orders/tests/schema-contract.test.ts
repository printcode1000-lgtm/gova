...
import { createMemoryMarketplaceDb } from "@/modules/data-access/domains/marketplace-orders/db/test-client";
import { MarketplaceOrderService } from "@/modules/data-access/domains/marketplace-orders/commands/marketplace-order-service";
import * as enums from "@/modules/marketplace-orders/domain/enums";
...
const columns: Record<string, string> = {
  ...
  seller_orders:
    "id order_id seller_id service_provider_id seller_order_type status seller_subtotal seller_discount_total seller_shipping_total seller_tax_total seller_commission_total seller_grand_total seller_payout_total fulfillment_snapshot_json created_at updated_at closed_at",
  order_items:

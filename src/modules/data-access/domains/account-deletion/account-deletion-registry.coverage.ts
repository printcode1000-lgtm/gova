...
export const DEFAULT_MIGRATION_SCAN_SOURCES: MigrationScanSource[] = [
  { database: 'users', directory: 'src/modules/data-access/core/database/migrations' },
  { database: 'profiles', directory: 'src/modules/data-access/core/database/profile/migrations' },
  { database: 'products', directory: 'src/modules/data-access/core/database/product/migrations' },
  { database: 'notifications', directory: 'src/modules/data-access/core/database/notifications/migrations' },
  { database: 'orders', directory: 'src/modules/data-access/domains/marketplace-orders/db/migrations' },
];

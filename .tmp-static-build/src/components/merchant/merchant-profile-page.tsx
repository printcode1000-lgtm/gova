...
export function MerchantProfilePage({ className }: MerchantProfilePageProps) {
  ...
  return (
    <main className={cn('gova-canvas', className)}>
      <MerchantHero merchant={data.merchant} />

      <div className="container px-4 sm:px-6 py-8 space-y-6">
        <section className="gova-merchant-band gova-merchant-band-primary">
          <MerchantOverview overview={data.overview} />
        </section>

        <section className="gova-merchant-band gova-merchant-band-tertiary">
          <QuickActions actions={data.quickActions} />
        </section>

        <section className="gova-merchant-band gova-merchant-band-secondary">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-6">
            ...
            <section className="gova-merchant-band gova-merchant-band-error">
              <CustomerReviews

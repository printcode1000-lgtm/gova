...
import { orderPurgeRepository } from "@/modules/data-access/domains/data-health/repositories/order-purge.repository.server";
...
sqlite.exec(
  readFileSync(
    path.join(
      process.cwd(),
      "src/modules/data-access/domains/marketplace-orders/db/migrations/0000_marketplace_orders.sql",
    ),
    "utf8",
  ),
);

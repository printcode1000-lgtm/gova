...
| [data-flows.md](./data-flows.md) | Multi-database sharding topology (Turso/SQLite), Drizzle ORM usage, inode-aware SQLite caching (`CachedSqliteConnection`), Cloudflare R2 object storage hierarchy, and client cache layers. |

...
- `npx tsx scripts/ota-publish.ts --notes "text"`: Overrides automatic release notes.
- `npx tsx scripts/ota-publish.ts --mandatory`: Signs manifest with `mandatory: true`.

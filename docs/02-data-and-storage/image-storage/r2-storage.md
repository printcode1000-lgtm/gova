...
- **Product images account:** `166409f3b449d8f1da0dee6d25ed3e08` — Bucket: `gova-storage` — Region: `WEUR` (`PRODUCT_R2_*`, managed by `@asol/storage-core`)
...
```bash
npm run r2:sync:cors       # General and Products buckets (via @asol/storage-core)

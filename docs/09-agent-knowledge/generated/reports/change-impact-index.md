...
| `auth` | feature | 3 | 4 | 121 | 0 | 22 | 16 |
| `cart` | feature | 1 | 5 | 7 | 0 | 5 | 11 |
| `catalog-studio` | feature | 2 | 1 | 3 | 0 | 0 | 7 |
| `categories` | feature | 4 | 0 | 48 | 0 | 14 | 6 |
...
| `simulation` | feature | 1 | 0 | 3 | 0 | 0 | 9 |
| `specialty-chat` | feature | 3 | 1 | 13 | 0 | 3 | 14 |
| `splash` | feature | 1 | 0 | 1 | 0 | 0 | 6 |
| `storage` | feature | 1 | 1 | 35 | 0 | 9 | 6 |
| `super-admin` | feature | 3 | 6 | 59 | 0 | 0 | 22 |
| `system-logs` | feature | 1 | 1 | 136 | 0 | 10 | 9 |
...
| `@asol/architecture-core` | package | 18 | 5 | 0 | 0 | 6 | 8 |
| `@asol/auth-core` | package | 11 | 6 | 141 | 0 | 58 | 2 |
| `@asol/backup-core` | package | 7 | 2 | 138 | 0 | 11 | 3 |
| `@asol/branding-core` | package | 12 | 1 | 41 | 0 | 8 | 1 |
| `@asol/catalog-core` | package | 8 | 1 | 13 | 0 | 17 | 1 |
| `@asol/data-core` | package | 55 | 23 | 145 | 0 | 159 | 20 |
| `@asol/data-health-core` | package | 7 | 2 | 138 | 0 | 45 | 0 |
| `@asol/dev-core` | package | 8 | 1 | 141 | 0 | 10 | 0 |
| `@asol/env-core` | package | 6 | 1 | 144 | 0 | 15 | 1 |
| `@asol/featured-marquee-core` | package | 6 | 1 | 137 | 0 | 12 | 1 |
| `@asol/format-core` | package | 7 | 2 | 41 | 0 | 37 | 0 |
| `@asol/google-play-store-assets-core` | package | 7 | 2 | 15 | 0 | 16 | 0 |
| `@asol/hero-slider-core` | package | 7 | 2 | 140 | 0 | 21 | 1 |
| `@asol/map-core` | package | 10 | 1 | 2 | 0 | 9 | 7 |
| `@asol/native-core` | package | 32 | 20 | 50 | 0 | 85 | 27 |
| `@asol/notifications-composition` | package | 10 | 1 | 0 | 0 | 2 | 4 |
| `@asol/notifications-core` | package | 20 | 14 | 146 | 0 | 90 | 5 |
| `@asol/observability-core` | package | 8 | 1 | 139 | 0 | 21 | 5 |
| `@asol/orders-composition` | package | 12 | 1 | 0 | 0 | 2 | 5 |
| `@asol/orders-core` | package | 17 | 6 | 140 | 0 | 41 | 1 |
...
| `@asol/product-core` | package | 9 | 1 | 138 | 0 | 26 | 0 |
...
| `@asol/release-core` | package | 8 | 5 | 14 | 0 | 45 | 4 |
...
| `@asol/signed-token-core` | package | 7 | 1 | 102 | 0 | 8 | 0 |
| `@asol/simulation-core` | package | 5 | 1 | 3 | 0 | 13 | 0 |
| `@asol/storage-core` | package | 34 | 22 | 142 | 0 | 97 | 5 |
...
| `@asol/system-logs-core` | package | 9 | 4 | 140 | 0 | 53 | 0 |
| `@asol/trending-ribbon-core` | package | 6 | 1 | 137 | 0 | 11 | 1 |
| `@asol/ui-registry-core` | package | 5 | 4 | 32 | 0 | 31 | 0 |

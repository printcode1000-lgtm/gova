...
| `@asol/api-contract-core` | package | 4 | 1 | 137 | 0 | 23 | 0 |
| `@asol/architecture-core` | package | 17 | 7 | 0 | 0 | 9 | 8 |
| `@asol/auth-core` | package | 11 | 5 | 143 | 0 | 102 | 3 |
...
| `@asol/data-core` | package | 57 | 26 | 148 | 0 | 175 | 22 |
| `@asol/data-health-core` | package | 7 | 2 | 138 | 0 | 46 | 0 |
| `@asol/dev-core` | package | 8 | 1 | 141 | 0 | 10 | 0 |
| `@asol/env-core` | package | 7 | 1 | 144 | 0 | 18 | 1 |
| `@asol/favorites-core` | package | 7 | 3 | 3 | 0 | 12 | 7 |
| `@asol/featured-marquee-core` | package | 6 | 1 | 137 | 0 | 14 | 1 |
...
| `@asol/hero-slider-core` | package | 7 | 2 | 140 | 0 | 23 | 1 |
...
| `@asol/product-core` | package | 9 | 1 | 138 | 0 | 29 | 0 |
...
| `@asol/storage-core` | package | 34 | 22 | 145 | 0 | 97 | 6 |
...
| `@asol/system-logs-core` | package | 9 | 4 | 140 | 0 | 57 | 0 |
| `@asol/trending-ribbon-core` | package | 6 | 1 | 137 | 0 | 13 | 1 |
| `@asol/vercel-deploy-core` | package | 11 | 7 | 142 | 0 | 44 | 2 |

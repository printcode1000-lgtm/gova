...
| `product` | feature | 1 | 1 | 26 | 0 | 12 | 22 |
...
| `release-commands` | feature | 3 | 2 | 9 | 0 | 1 | 8 |
...
| `simulation` | feature | 1 | 0 | 3 | 0 | 0 | 8 |
| `specialty-chat` | feature | 3 | 1 | 13 | 0 | 3 | 14 |
| `splash` | feature | 1 | 0 | 1 | 0 | 0 | 6 |
| `storage` | feature | 1 | 1 | 35 | 0 | 9 | 6 |
| `super-admin` | feature | 3 | 5 | 58 | 0 | 0 | 21 |
| `system-logs` | feature | 1 | 1 | 134 | 0 | 10 | 8 |
| `vehicle-catalog` | feature | 2 | 0 | 2 | 0 | 1 | 1 |
| `voice-input` | feature | 1 | 0 | 0 | 0 | 0 | 2 |
| `@asol/account-bridge` | package | 13 | 5 | 26 | 0 | 13 | 4 |
| `@asol/account-declarations` | package | 13 | 8 | 4 | 0 | 30 | 0 |
| `@asol/architecture-core` | package | 18 | 4 | 0 | 0 | 6 | 7 |
| `@asol/auth-core` | package | 10 | 6 | 139 | 0 | 57 | 2 |
| `@asol/backup-core` | package | 7 | 2 | 136 | 0 | 11 | 3 |
| `@asol/branding-core` | package | 12 | 1 | 41 | 0 | 8 | 1 |
| `@asol/catalog-core` | package | 8 | 1 | 13 | 0 | 17 | 1 |
| `@asol/data-core` | package | 55 | 23 | 143 | 0 | 159 | 20 |
| `@asol/data-health-core` | package | 7 | 2 | 136 | 0 | 45 | 0 |
| `@asol/dev-core` | package | 8 | 1 | 139 | 0 | 10 | 0 |
| `@asol/env-core` | package | 6 | 1 | 141 | 0 | 14 | 1 |
| `@asol/featured-marquee-core` | package | 6 | 1 | 135 | 0 | 12 | 1 |
| `@asol/format-core` | package | 7 | 2 | 41 | 0 | 37 | 0 |
| `@asol/google-play-store-assets-core` | package | 7 | 2 | 15 | 0 | 16 | 0 |
| `@asol/hero-slider-core` | package | 7 | 2 | 138 | 0 | 21 | 1 |
| `@asol/map-core` | package | 10 | 1 | 2 | 0 | 9 | 7 |
| `@asol/native-core` | package | 32 | 20 | 49 | 0 | 79 | 27 |
| `@asol/notifications-composition` | package | 10 | 1 | 0 | 0 | 2 | 4 |
| `@asol/notifications-core` | package | 20 | 14 | 143 | 0 | 88 | 5 |
| `@asol/observability-core` | package | 8 | 1 | 137 | 0 | 21 | 5 |
| `@asol/orders-composition` | package | 12 | 1 | 0 | 0 | 2 | 5 |
| `@asol/orders-core` | package | 17 | 6 | 138 | 0 | 41 | 1 |
| `@asol/ota-core` | package | 35 | 26 | 28 | 0 | 40 | 13 |
| `@asol/page-save-core` | package | 29 | 3 | 0 | 0 | 8 | 0 |
| `@asol/page-snapshot-core` | package | 8 | 1 | 0 | 0 | 3 | 0 |
| `@asol/product-core` | package | 9 | 1 | 136 | 0 | 26 | 0 |
...
| `@asol/release-core` | package | 8 | 5 | 11 | 0 | 45 | 4 |
...
| `@asol/signed-token-core` | package | 7 | 1 | 101 | 0 | 8 | 0 |
| `@asol/simulation-core` | package | 5 | 1 | 3 | 0 | 13 | 0 |
| `@asol/storage-core` | package | 34 | 22 | 140 | 0 | 97 | 5 |
...
| `@asol/system-logs-core` | package | 9 | 4 | 138 | 0 | 52 | 0 |
| `@asol/trending-ribbon-core` | package | 6 | 1 | 135 | 0 | 11 | 1 |
| `@asol/vercel-deploy-core` | package | 7 | 4 | 22 | 0 | 26 | 1 |

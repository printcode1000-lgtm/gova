...
| `google-play-console` | feature | 2 | 1 | 24 | 0 | 2 | 12 |
...
| `page-save` | feature | 3 | 2 | 22 | 0 | 10 | 7 |
...
| `super-admin` | feature | 2 | 6 | 42 | 0 | 3 | 22 |
| `system-logs` | feature | 1 | 2 | 117 | 0 | 10 | 11 |
| `vehicle-catalog` | feature | 2 | 0 | 2 | 0 | 1 | 1 |
| `voice-input` | feature | 1 | 0 | 0 | 0 | 0 | 2 |
| `@asol/account-bridge` | package | 18 | 8 | 26 | 0 | 26 | 4 |
| `@asol/account-declarations` | package | 14 | 9 | 22 | 0 | 39 | 0 |
| `@asol/api-contract-core` | package | 4 | 1 | 123 | 0 | 24 | 0 |
| `@asol/architecture-core` | package | 17 | 7 | 0 | 0 | 9 | 8 |
| `@asol/auth-core` | package | 11 | 5 | 125 | 0 | 102 | 3 |
...
| `@asol/cors` | package | 13 | 3 | 58 | 0 | 31 | 0 |
| `@asol/data-core` | package | 62 | 26 | 129 | 0 | 186 | 21 |
| `@asol/dev-core` | package | 7 | 1 | 18 | 0 | 1 | 0 |
| `@asol/env-core` | package | 8 | 1 | 128 | 0 | 25 | 1 |
| `@asol/favorites-core` | package | 7 | 3 | 3 | 0 | 12 | 7 |
| `@asol/featured-marquee-core` | package | 6 | 1 | 122 | 0 | 14 | 1 |
...
| `@asol/hero-slider-core` | package | 7 | 2 | 122 | 0 | 23 | 1 |
...
| `@asol/notifications-core` | package | 19 | 15 | 130 | 0 | 99 | 5 |
| `@asol/observability-core` | package | 8 | 1 | 119 | 0 | 23 | 4 |
| `@asol/orders-composition` | package | 12 | 1 | 0 | 0 | 2 | 5 |
| `@asol/orders-core` | package | 17 | 6 | 125 | 0 | 54 | 1 |
| `@asol/ota-core` | package | 36 | 26 | 31 | 0 | 44 | 14 |
| `@asol/page-save-core` | package | 27 | 4 | 0 | 0 | 8 | 0 |
| `@asol/page-snapshot-core` | package | 8 | 1 | 0 | 0 | 3 | 0 |
| `@asol/product-card-core` | package | 5 | 1 | 3 | 0 | 16 | 5 |
| `@asol/product-core` | package | 9 | 1 | 123 | 0 | 29 | 0 |
...
| `@asol/system-logs-core` | package | 9 | 5 | 122 | 0 | 59 | 0 |
| `@asol/trending-ribbon-core` | package | 6 | 1 | 122 | 0 | 13 | 1 |
| `@asol/vercel-deploy-core` | package | 13 | 8 | 127 | 0 | 46 | 2 |

...
| `profile` | feature | 1 | 6 | 35 | 0 | 13 | 33 |
...
| `seller-card` | feature | 1 | 1 | 5 | 0 | 4 | 6 |
...
| `@asol/data-core` | package | 56 | 25 | 143 | 0 | 170 | 20 |
| `@asol/data-health-core` | package | 7 | 2 | 136 | 0 | 45 | 0 |
| `@asol/dev-core` | package | 8 | 1 | 139 | 0 | 10 | 0 |
| `@asol/env-core` | package | 7 | 1 | 142 | 0 | 18 | 1 |
| `@asol/featured-marquee-core` | package | 6 | 1 | 135 | 0 | 14 | 1 |
...
| `@asol/hero-slider-core` | package | 7 | 2 | 138 | 0 | 23 | 1 |
| `@asol/map-core` | package | 10 | 1 | 2 | 0 | 9 | 7 |
| `@asol/native-core` | package | 37 | 20 | 48 | 0 | 85 | 27 |
| `@asol/notifications-composition` | package | 11 | 1 | 0 | 0 | 2 | 4 |
| `@asol/notifications-core` | package | 19 | 15 | 144 | 0 | 99 | 5 |
...
| `@asol/product-core` | package | 9 | 1 | 136 | 0 | 27 | 0 |
...
| `@asol/release-core` | package | 9 | 9 | 14 | 0 | 59 | 4 |
| `@asol/secrets-core` | package | 5 | 1 | 15 | 0 | 8 | 0 |
| `@asol/service-mirror-core` | package | 11 | 1 | 0 | 0 | 3 | 1 |
| `@asol/service-runtime-core` | package | 9 | 2 | 0 | 0 | 27 | 1 |
| `@asol/signed-token-core` | package | 7 | 1 | 104 | 0 | 8 | 0 |
| `@asol/storage-core` | package | 34 | 22 | 140 | 0 | 97 | 6 |
...
| `@asol/system-logs-core` | package | 9 | 4 | 138 | 0 | 58 | 0 |
| `@asol/trending-ribbon-core` | package | 6 | 1 | 135 | 0 | 13 | 1 |
| `@asol/vercel-deploy-core` | package | 11 | 7 | 25 | 0 | 42 | 2 |
| `control` | service | 2 | 0 | 0 | 0 | 0 | 18 |
| `notifications` | service | 6 | 0 | 0 | 0 | 0 | 4 |

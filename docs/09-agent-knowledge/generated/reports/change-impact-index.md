...
| `super-admin` | feature | 2 | 6 | 41 | 0 | 3 | 23 |
| `system-logs` | feature | 1 | 2 | 115 | 0 | 10 | 11 |
| `vehicle-catalog` | feature | 2 | 0 | 2 | 0 | 1 | 1 |
| `voice-input` | feature | 1 | 0 | 0 | 0 | 0 | 2 |
| `@asol/account-bridge` | package | 18 | 8 | 26 | 0 | 26 | 4 |
| `@asol/account-declarations` | package | 14 | 9 | 15 | 0 | 39 | 0 |
| `@asol/api-contract-core` | package | 4 | 1 | 121 | 0 | 25 | 0 |
| `@asol/architecture-core` | package | 17 | 7 | 0 | 0 | 9 | 8 |
| `@asol/auth-core` | package | 11 | 5 | 123 | 0 | 100 | 3 |
...
| `@asol/hero-slider-core` | package | 7 | 2 | 120 | 0 | 23 | 1 |
| `@asol/map-core` | package | 10 | 1 | 2 | 0 | 9 | 7 |
| `@asol/native-core` | package | 38 | 21 | 49 | 0 | 86 | 27 |
| `@asol/notifications-composition` | package | 11 | 1 | 0 | 0 | 2 | 4 |
| `@asol/notifications-core` | package | 19 | 15 | 127 | 0 | 95 | 5 |
| `@asol/observability-core` | package | 8 | 1 | 117 | 0 | 23 | 4 |
| `@asol/orders-composition` | package | 12 | 1 | 0 | 0 | 2 | 5 |
| `@asol/orders-core` | package | 17 | 6 | 123 | 0 | 54 | 1 |
| `@asol/ota-core` | package | 36 | 26 | 28 | 0 | 44 | 14 |
...
| `@asol/product-core` | package | 9 | 1 | 121 | 0 | 29 | 0 |
...
| `@asol/release-core` | package | 9 | 9 | 11 | 0 | 59 | 4 |
...
| `@asol/system-logs-core` | package | 9 | 5 | 120 | 0 | 59 | 0 |
| `@asol/trending-ribbon-core` | package | 6 | 1 | 120 | 0 | 13 | 1 |
| `@asol/vercel-deploy-core` | package | 12 | 8 | 124 | 0 | 34 | 2 |

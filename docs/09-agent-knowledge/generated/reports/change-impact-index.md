...
| `notifications` | feature | 3 | 32 | 44 | 0 | 10 | 16 |
...
| `system-logs` | feature | 1 | 2 | 116 | 0 | 10 | 11 |
...
| `@asol/api-contract-core` | package | 4 | 1 | 122 | 0 | 25 | 0 |
| `@asol/architecture-core` | package | 17 | 7 | 0 | 0 | 9 | 8 |
| `@asol/auth-core` | package | 11 | 5 | 124 | 0 | 100 | 3 |
| `@asol/branding-core` | package | 12 | 1 | 42 | 0 | 8 | 1 |
| `@asol/catalog-core` | package | 8 | 1 | 13 | 0 | 17 | 1 |
| `@asol/control-composition` | package | 6 | 1 | 0 | 0 | 2 | 1 |
| `@asol/cors` | package | 13 | 3 | 59 | 0 | 31 | 0 |
| `@asol/data-core` | package | 59 | 27 | 128 | 0 | 187 | 19 |
| `@asol/dev-core` | package | 7 | 1 | 18 | 0 | 1 | 0 |
| `@asol/env-core` | package | 8 | 1 | 126 | 0 | 25 | 1 |
| `@asol/favorites-core` | package | 7 | 3 | 3 | 0 | 12 | 7 |
| `@asol/featured-marquee-core` | package | 6 | 1 | 121 | 0 | 14 | 1 |
...
| `@asol/hero-slider-core` | package | 7 | 2 | 121 | 0 | 23 | 1 |
...
| `@asol/notifications-core` | package | 19 | 15 | 128 | 0 | 95 | 5 |
| `@asol/observability-core` | package | 8 | 1 | 118 | 0 | 23 | 4 |
| `@asol/orders-composition` | package | 12 | 1 | 0 | 0 | 2 | 5 |
| `@asol/orders-core` | package | 17 | 6 | 124 | 0 | 54 | 1 |
...
| `@asol/product-core` | package | 9 | 1 | 122 | 0 | 29 | 0 |
...
| `@asol/system-logs-core` | package | 9 | 5 | 122 | 0 | 61 | 0 |
| `@asol/trending-ribbon-core` | package | 6 | 1 | 121 | 0 | 13 | 1 |
| `@asol/vercel-deploy-core` | package | 12 | 8 | 125 | 0 | 35 | 2 |

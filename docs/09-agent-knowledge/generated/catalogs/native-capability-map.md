...
| android | `android.permission.READ_EXTERNAL_STORAGE` | `android/app/src/main/AndroidManifest.xml` | `src/features/storage` | `@asol/env-core`, `@asol/storage-core`, `@asol/storage-image-manager-core` | AndroidManifest permission/component |
...
| android | `android.permission.WRITE_EXTERNAL_STORAGE` | `android/app/src/main/AndroidManifest.xml` | `src/features/storage` | `@asol/storage-core`, `@asol/storage-image-manager-core` | AndroidManifest permission/component |

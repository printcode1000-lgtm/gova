...
| `npm run local-agent:direct:daemon` | `Tooling` | 1 |  | 0 |
| `npm run local-agent:direct:doctor` | `Tooling` | 1 |  | 0 |
| `npm run local-agent:direct:install` | `Tooling` | 1 |  | 0 |
| `npm run local-agent:direct:key:rotate` | `Tooling` | 1 |  | 0 |
| `npm run local-agent:direct:key:status` | `Tooling` | 1 |  | 0 |
| `npm run local-agent:direct:kill-switch` | `Tooling` | 1 |  | 0 |
| `npm run local-agent:direct:restart` | `Tooling` | 1 |  | 0 |
| `npm run local-agent:direct:revoke` | `Tooling` | 1 |  | 0 |
| `npm run local-agent:direct:revoke-all` | `Tooling` | 1 |  | 0 |
| `npm run local-agent:direct:sessions` | `Tooling` | 1 |  | 0 |
| `npm run local-agent:direct:start` | `Tooling` | 1 |  | 0 |
| `npm run local-agent:direct:status` | `Tooling` | 1 |  | 0 |
| `npm run local-agent:direct:stop` | `Tooling` | 1 |  | 0 |
...
| `npm run test:deployment-tools` | `Tooling` | 15 |  | 0 |

...
Handles registration, login, profile update, and email/phone normalization. Depends on `AuthUserRepositoryPort` and optional `ProfileSpecialtiesPort` (injected in bootstrap).

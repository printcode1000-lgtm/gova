...
/**
 * Copies the shared modules the orders service needs into its own folder.
 *
 * The service is deployed from `services/orders` alone — nothing outside
...
const SERVICE_ROOT = path.join(ROOT, 'services', 'orders');
 ...
 */
const RUNTIME_ASSETS: readonly string[] = [];

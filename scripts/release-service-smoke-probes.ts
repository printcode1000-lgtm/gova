...
/**
 * Main (`gova`) reuses the products data read already proven in
 * `smoke:production` / the products service probe — not `/api/health`.
 */
export function mainDeployedSmokeProbe(): ServiceSmokeProbe {

...
/**
 * Copies the shared modules the profiles service needs into its own folder.
 *
 * The service is deployed from `services/profiles` alone — nothing outside
...
const SERVICE_ROOT = path.join(ROOT, 'services', 'profiles');
